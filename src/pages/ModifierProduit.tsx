...
function ModifierProduit() {
    ...
    const [formData, setFormData] = useState({
        name: 'Service WhatsApp Pro', // TODO: Replace with actual data from API
        description: 'Service professionnel de gestion WhatsApp', // TODO: Replace with actual data from API
        price: '5000', // TODO: Replace with actual data from API
        category: 'service', // TODO: Replace with actual data from API
        images: [] as File[]
    });
